                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Silakan Mendaftar Akun!</h1>
                                    </div>
                                    ...
                                    <form class="user" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="name" class="form-control form-control-user"
                                                ...
                                                placeholder="Nama" style="border-color: #106466; border-width: 1px;" id="namne" name="name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Konfirmasi Password" style="border-color: #106466; border-width: 1px;" id="confirm_password" name="confirm_password">
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        Sudah punya akun? <a class="small" href="{{ route('login') }}">MASUK</a>
                                    </div>
                                </div>
                            </div>
                        </div>
